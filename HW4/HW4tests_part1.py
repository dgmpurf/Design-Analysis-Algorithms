...
class HW4Sampletests_part1(unittest.TestCase):
    ...
    def test_putinterval4(self):
        ...
        opPush('(5)')
        putinterval()
        self.assertEqual(opPop(),'(CptS555-and-CptS522)')
        self.assertTrue(len(opstack)==0)
    ...
    #     # [1 1 1 add y x sub] 
    #     # [(aBCd) 1 2 getinterval (BC) eq]
    #     self.assertEqual(evaluateArray([1,1,1,'add','y','x','mul']), [1,2,2])
