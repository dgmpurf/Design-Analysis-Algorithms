...
class HW3SampleTests(unittest.TestCase):
    def setUp(self):
        ...
        self.CDCdata1 = { 'King':{'Mar':2777,'Apr':3620,'May':1860,'Jun':2157,'July':5014,'Aug':4327,'Sep':2843},
            'Pierce':{'Mar':460,'Apr':965,'May':522,'Jun':647,'July':2470,'Aug':1776,'Sep':1266}, 
            'Snohomish':{'Mar':1301,'Apr':1145,'May':532,'Jun':568,'July':1540,'Aug':1134,'Sep':811}, 
            'Spokane':{'Mar':147,'Apr':222,'May':233,'Jun':794,'July':2412,'Aug':1530,'Sep':1751}, 
            'Whitman' : {'Apr':7,'May':5,'Jun':19,'July':51,'Aug':514,'Sep':732, 'Oct':278} }

        self.CDCdata2 = { 'King':{'Mar':2706,'Apr':3333,'May':1860,'Jun':2157,'July':5014,'Aug':4327,'Sep':2843},
            'Pierce':{'Mar':460,'Apr':965,'May':522,'Jun':647,'July':2470,'Aug':1776,'Sep':1266}, 
            'Snohomish':{'Mar':1301,'Apr':1145,'May':532,'Jun':568,'July':1540,'Aug':1134,'Sep':811}, 
            'Spokane':{'Mar':147,'Apr':222,'May':233,'Jun':794,'July':2412,'Aug':1530,'Sep':1751}, 
            'Whitman' : {'Apr':7,'May':5,'Jun':19,'July':51,'Aug':514,'Sep':732, 'Oct':278} }    
    ...
    def test_getNumCases(self):
        ...
        self.assertEqual(getNumCases(self.CDCdata,['King'],['July']),5014)
        self.assertEqual(getNumCases(self.CDCdata,['Pierce'],['July']),2470)
    ...
    def test_getMonthlyCases(self):
        ...
        monthlyCases1 = {'Mar': {'King': 2777, 'Pierce': 460, 'Snohomish': 1301, 'Spokane': 147}, 'Apr': {'King': 3620, 'Pierce': 965, 'Snohomish': 1145, 'Spokane': 222, 'Whitman': 7}, 'May': {'King': 1860, 'Pierce': 522, 'Snohomish': 532, 'Spokane': 233, 'Whitman': 5}, 'Jun': {'King': 2157, 'Pierce': 647, 'Snohomish': 568, 'Spokane': 794, 'Whitman': 19}, 'July': {'King': 5014, 'Pierce': 2470, 'Snohomish': 1540, 'Spokane': 2412, 'Whitman': 51}, 'Aug': {'King': 4327, 'Pierce': 1776, 'Snohomish': 1134, 'Spokane': 1530, 'Whitman': 514}, 'Sep': {'King': 2843, 'Pierce': 1266, 'Snohomish': 811, 'Spokane': 1751, 'Whitman': 732}, 'Oct': {'Whitman': 278}}
        self.assertDictEqual(getMonthlyCases(self.CDCdata1),monthlyCases1)
        monthlyCases2 = {'Mar': {'King': 2706, 'Pierce': 460, 'Snohomish': 1301, 'Spokane': 147}, 'Apr': {'King': 3333, 'Pierce': 965, 'Snohomish': 1145, 'Spokane': 222, 'Whitman': 7}, 'May': {'King': 1860, 'Pierce': 522, 'Snohomish': 532, 'Spokane': 233, 'Whitman': 5}, 'Jun': {'King': 2157, 'Pierce': 647, 'Snohomish': 568, 'Spokane': 794, 'Whitman': 19}, 'July': {'King': 5014, 'Pierce': 2470, 'Snohomish': 1540, 'Spokane': 2412, 'Whitman': 51}, 'Aug': {'King': 4327, 'Pierce': 1776, 'Snohomish': 1134, 'Spokane': 1530, 'Whitman': 514}, 'Sep': {'King': 2843, 'Pierce': 1266, 'Snohomish': 811, 'Spokane': 1751, 'Whitman': 732}, 'Oct': {'Whitman': 278}}
    ...
    def test_mostCases(self):
        ...
        self.assertEqual(mostCases(self.CDCdata),('Mar', 4614))
        self.assertEqual(mostCases(self.CDCdata),('Apr', 5959))
    ...
    def test_searchDicts(self):
        ...
        self.assertEqual(searchDicts(dictList,"n"),None)
    ...
    def test_searchDicts2(self):
        ...
        self.assertEqual(searchDicts2(dictList2,"n"),None)
    ...
    def test_adduptoZero(self):
        ...
        self.assertEqual(adduptoZero(numbers2,2),[[-1,1], [-2,2],[-3,3]])
        self.assertEqual(adduptoZero(numbers3,3),[])


    def test_getLongest(self):
        strings = ['1',['22',['333',['4444','55555',['666666']],'7777777'],'4444'],'22']
        pets=[['cat',['dog','horse'],['bird',['bunny','fish']]]]
        classes=[['cpts335',['cs335','cpts_335'],['cp335',['c335','cpts3']]]]
        names=[['ke',['kema','jone'],['walliams',['key','neo']]]]
        self.assertEqual(getLongest (strings), '7777777')
        self.assertEqual(getLongest (pets), 'horse')
        self.assertEqual(getLongest (classes), 'cpts_335')
        self.assertEqual(getLongest (names), 'walliams')
    ...
    def test_apply2nextN(self):
        ...
        #test4
        strIter =iter('111222333444555666777888999')
        iSequence = apply2nextN(lambda a,b:a+b, 4, strIter)
        self.assertEqual(iSequence.__next__(),'111')
        self.assertEqual(iSequence.__next__(),'222')
        self.assertEqual(iSequence.__next__(),'333')
        rest = []
        for item in iSequence:
            rest.append(item)
        self.assertEqual(rest,['444','555','666','777','888','999'])

        #test5
        strIter =iter('ooopppqqqrrrsssttt')
        iSequence = apply2nextN(lambda a,b:a+b, 4, strIter)
        self.assertEqual(iSequence.__next__(),'ooo')
        self.assertEqual(iSequence.__next__(),'ppp')
        self.assertEqual(iSequence.__next__(),'qqq')
        rest = []
        for item in iSequence:
            rest.append(item)
        self.assertEqual(rest,['rrr','sss','ttt'])
