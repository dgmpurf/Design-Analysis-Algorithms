...
#test
    def test_input12_parse(self):
        testinput12 = """
                ...
                n fact
        """
        parseOutput = {'codearray': ['/n', 3, 'def', '/fact', {'codearray': [0, 'dict', 'begin', '/n', 'exch', 'def', 'n', 2, 'lt', {'codearray': [1]}, {'codearray': ['n', 1, 'sub', 'fact', 'n', 'mul']}, 'ifelse', 'end']}, 'def', 'n', 'fact']}
    ...
    def test_input12(self):
        ...
        """
        opstackOutput = [120]
        dictstackOutput = [{'/n': 3, '/fact': {'codearray': [0, 'dict', 'begin', '/n', 'exch', 'def', 'n', 2, 'lt', {'codearray': [1]}, {'codearray': ['n', 1, 'sub', 'fact', 'n', 'mul']}, 'ifelse', 'end']}}]
        ...
        testinput13 = """
          /fact{
                ...
                begin
                    /n exch def
                    1
                    n -1 1 {mul /n n 1 add def} for 
                end
            } def
            6 fact
        """
        parseOutput = {'codearray': ['/fact', {'codearray': [0, 'dict', 'begin', '/n', 'exch', 'def', 1, 'n', -1, 1, {'codearray': ['mul', '/n', 'n', 1, 'add', 'def']}, 'for', 'end']}, 'def', 6, 'fact']}
    ...
    def test_input13(self):
        ...
        """
        opstackOutput = [720]
        dictstackOutput = [{'/fact': {'codearray': [0, 'dict', 'begin', '/n', 'exch', 'def', 1, 'n', -1, 1, {'codearray': ['mul', '/n', 'n', 1, 'add', 'def']}, 'for', 'end']}}]
    ...
    def test_input14_parse(self):
        testinput14 = """
            (COVID-19 soluson)
                ...
                stack
        """
        parseOutput = {'codearray': ['(COVID-19 soluson)', 'dup', '( )', 'search', 'pop', 'exch', 'pop', '(-19)', 'search', {'codearray': ['pop', 'pop', 'pop', '(soluson)', 'eq', {'codearray': ['(yay)']}, {'codearray': ['(???)']}, 'ifelse']}, 'if', 'stack']}
    ...
    def test_input14(self):
        testinput14 = """
            (COVID-19 soluson)
                ...
                stack
        """
        opstackOutput = ['(COVID-19 soluson)', '(yay)']
        dictstackOutput = [{}]
    ...
    def test_input15_parse(self):
        testinput15 = """
                [1 2 3 4 5 6] aload /myA exch def
                count copy [0 0 0 0 0 0] astore
                myA eq
                stack
        """
        parseOutput = {'codearray': [[1, 2, 3, 4, 5, 6], 'aload', '/myA', 'exch', 'def', 'count', 'copy', [0, 0, 0, 0, 0, 0], 'astore', 'myA', 'eq', 'stack']}
    ...
    def test_input15(self):
        testinput15 = """
                ...
                stack
        """
        opstackOutput = [1, 2, 3, 4, 5, 6, True]
        dictstackOutput = [{'/myA': [1, 2, 3, 4, 5, 6]}]
    ...
    def test_input16_parse(self):
        testinput16 = """
                ...
                x y
        """
        parseOutput = {'codearray': ['/x', 1, 'def', '/y', 200, 'def', 1, 'dict', 'begin', '/x', 10, 'def', 1, 'dict', 'begin', '/y', 3, 'def', 'x', 'y', 'end', '/y', 20, 'def', 'x', 'y', 'end', 'x', 'y']}
    ...
    def test_input16(self):
        testinput16 = """
                ...
                x y
        """
        opstackOutput = [10, 3, 10, 20, 1, 200]
        dictstackOutput = [{'/x': 1, '/y': 2}]
